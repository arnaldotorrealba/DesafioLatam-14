...
// Función que genera el template, donde:
//      data: array de objetos con toda la data.
//      numberOfCards: número de cards a generar en el template, opcional.
// retorna un string con el template generado a partir de los argumentos dados.
